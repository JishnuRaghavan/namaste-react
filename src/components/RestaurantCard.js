...
const RestaurantCard    =   (props)=>{
    ...
    return (
        <div className="m-4 p-4 w-[250px] rounded-lg h-[350px] flex flex-col bg-gray-100 hover:bg-gray-300">
            <img 
            className="rounded-lg h-[50%]"
            alt="bektash-logo"
            src={CDN_URL+cloudinaryImageId} />
            <h3 className="font-bold py-2 text-lg text-center">{name}</h3>
            <div style={{padding:0,margin:0}} className="res-card-details">
              <div style={{display:'flex'}}>
                ...
                <h4 style={{padding:0,margin:0}}>{avgRating}</h4>
              </div>
